...
namespace DeadMosquito.IosGoodies
{
    ...
    public static class IGDevice
    {
        ...
        private static extern bool _uiDeviceIsMultitaskingSupported();

        [DllImport("__Internal")]
        private static extern string _uiDeviceGetName();

        [DllImport("__Internal")]
        private static extern string _uiDeviceGetSystemName();

        [DllImport("__Internal")]
        private static extern string _uiDeviceGetSystemVersion();

        [DllImport("__Internal")]
        private static extern string _uiDeviceGetModel();

        [DllImport("__Internal")]
        private static extern string _uiDeviceGetLocalizedModel();

        [DllImport("__Internal")]
        private static extern int _uiDeviceGetUserInterfaceIdiom();

        [DllImport("__Internal")]
        private static extern string _uiDeviceGetUUID();

        #region battery_internal

        [DllImport("__Internal")]
        private static extern float _uiDeviceGetBatteryLevel();

        [DllImport("__Internal")]
        private static extern bool _uiDeviceIsBatteryMonitoringEnabled();

        [DllImport("__Internal")]
        private static extern int _uiDeviceGetBatteryState();

        [DllImport("__Internal")]
        private static extern void _uiDeviceSetBatteryMonitoringEnabled(bool enabled);

        #endregion

        #region proximity_sensor_internal

        [DllImport("__Internal")]
        private static extern void _uiDeviceSetProximityMonitoringEnabled(bool enabled);

        [DllImport("__Internal")]
        private static extern bool _uiDeviceIsProximityMonitoringEnabled();

        [DllImport("__Internal")]
        private static extern bool _uiDeviceProximityState();
