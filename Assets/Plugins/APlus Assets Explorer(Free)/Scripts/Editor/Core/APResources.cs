...
namespace APlusFree
{
    ...
    public class APResources
    {
        ...
        public static APTexture GetAPTextureFromAssetGuid(string guid)
        {
            ...
            //
            tImporter.GetPlatformTextureSettings(EditorUserBuildSettings.activeBuildTarget.ToString(), out maxTextureSize, out importerFormat, out compressQuality);
...
#if UNITY_5_5_OR_NEWER
            apTexture.TextureFormat = importerCompression.ToString();
#else
