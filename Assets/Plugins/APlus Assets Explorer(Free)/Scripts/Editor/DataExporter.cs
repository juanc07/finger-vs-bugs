...
namespace APlusFree
{
    public class DataExporter
    {
        ...
        {
            string header = "Name,FileSize,StorageSize,RuntimeSize,MaxSize,MipMap,ReadWrite,TextureFormat,TextureType,Width,Height,WidthInPixel,HeightInPixel,Unused,Path";
